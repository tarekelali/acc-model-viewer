...
serve(async (req) => {
  ...
  try {
    ...
    const appBundleAlias = Deno.env.get('DA_APPBUNDLE_ALIAS') || `${clientId}.RevitTransformApp+1`;
    const activityAlias = Deno.env.get('DA_ACTIVITY_ALIAS') || `${clientId}.RevitTransformActivity+1`;
